    ...
    <div className="home_page">
      ...
      <div className="section explore_section">
          ...
          <div className="explore_container">
              {places.map(place=>{
                  return <div className="place_item" >
                      <Place key={place} urlImg={place.urlImg} name={place.name} driveTime={place.driveTime}/>
                  </div>
          ...
          <div className="home_container">
              {homes.map(home=>{
                  return <div className="home_item" >
                      <Card key={home} urlImg={home.urlImg} title={home.title}/>
                  </div>
...
<div className="section hosting_section">
    ...
    <div className="hosting_content">
        <h2>Try hosting</h2>
        <p>Earn extra income and unclock new opportunities by sharing your space</p>
      ...
      <div className="section acti_section">
          ...
          <div className="acti_container">
              {acties.map(acti=>{
                  return <div className="acti_item" >
                      <Card key={acti} urlImg={acti.urlImg} title={acti.title} subTitle={acti.subTitle}/>
                  </div>
